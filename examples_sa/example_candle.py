...
def createSketch_Sketch(doc):
    ...
    geo0 = Sketch.addGeometry(
        Part.Circle(Vector(0.00, 12.01, 0.00), Vector(0.0, 0.0, 1.0), 1.00)
    )
    Sketch.toggleConstruction(geo0)
    geo1 = Sketch.addGeometry(
        Part.Circle(Vector(-1.00, 12.42, 0.00), Vector(0.0, 0.0, 1.0), 1.00)
    )
    Sketch.toggleConstruction(geo1)
    geo2 = Sketch.addGeometry(
        Part.Circle(Vector(-1.43, 15.03, 0.00), Vector(0.0, 0.0, 1.0), 1.00)
    )
    Sketch.toggleConstruction(geo2)
    geo3 = Sketch.addGeometry(
        Part.Circle(Vector(-0.15, 15.56, 0.00), Vector(0.0, 0.0, 1.0), 1.00)
    )
    Sketch.toggleConstruction(geo3)
    geo4 = Sketch.addGeometry(
        Part.Circle(Vector(0.00, 16.62, 0.00), Vector(0.0, 0.0, 1.0), 1.00)
    )
    Sketch.toggleConstruction(geo4)
    geo5 = Sketch.addGeometry(
        Part.BSplineCurve(
            [
                Vector(0.00, 12.01, 0.00),
                Vector(-1.00, 12.42, 0.00),
                Vector(-1.43, 15.03, 0.00),
                Vector(-0.15, 15.56, 0.00),
                Vector(0.00, 16.62, 0.00),
            ]
        )
    )
    ...
    Sketch.addConstraint(
        Sketcher.Constraint(
            "InternalAlignment:Sketcher::BSplineControlPoint", geo0, 3, geo5, 0
        )
    )
    Sketch.addConstraint(
        Sketcher.Constraint(
            "InternalAlignment:Sketcher::BSplineControlPoint", geo1, 3, geo5, 1
        )
    )
    Sketch.addConstraint(
        Sketcher.Constraint(
            "InternalAlignment:Sketcher::BSplineControlPoint", geo2, 3, geo5, 2
        )
    )
    Sketch.addConstraint(
        Sketcher.Constraint(
            "InternalAlignment:Sketcher::BSplineControlPoint", geo3, 3, geo5, 3
        )
    )
    Sketch.addConstraint(
        Sketcher.Constraint(
            "InternalAlignment:Sketcher::BSplineControlPoint", geo4, 3, geo5, 4
        )
    )
