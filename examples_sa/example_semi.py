...
def createSketch_Sketch(doc):
    ...
    geo0 = Sketch.addGeometry(
        Part.LineSegment(
            Vector(17.57187, 4.200229, 0.0),
            Vector(3.394269999999999, -5.662041000000004, 0.0),
        )
    )
...
def createSketch_Sketch002(doc):
    ...
    geo0 = Sketch002.addGeometry(
        Part.LineSegment(
            Vector(35.877303000000005, 5.425019999999973, 0.0),
            Vector(49.675442217789794, -5.392686170185302, 0.0),
        )
    )
    geo1 = Sketch002.addGeometry(
        Part.ArcOfCircle(
            Part.Circle(
                Vector(36.78444246898194, -7.626625831826473, 0.0),
                Vector(0.0, 0.0, 1.0),
                13.083132688145355,
            ),
            0.1715903905166062,
