...
def make_Test3D():
    ...
    Cube.Placement = Placement(
        Vector(20.00, -3.17, -2.00),
        Rotation(-0.0, -0.0, 0.25881904510252074, 0.9659258262890684),
    )
    ...
    HalfSphere.Placement = Placement(
        Vector(25.86, -24.61, 0.00),
        Rotation(0.0, 0.0, -0.793353340291235, 0.6087614290087205),
    )
    HalfSphere.Tool = Cube002
    HalfSphere.ViewObject.DiffuseColor = [
        (0.80, 0.80, 0.80, 0.00),
        (0.80, 0.80, 0.80, 0.00),
    ]
