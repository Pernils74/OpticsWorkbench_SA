...
__doc__ = translate(
    "Sun Ray", "Declare your FreeCAD objects to be optical mirrors, lenses or absorbers"
)


class SunRayWorker:
    def __init__(self, fp, rays=[]):  # an instance of Part::FeaturePython
        fp.addProperty(
            "App::PropertyLinkList",
            "Rays",
            "SunRay",
            translate("Sun Ray", "Create rays of different wavelength"),
        ).Rays = rays
        fp.Proxy = self
        self.update = True
    ...
    def GetResources(self):
        ...
        return {
            ...
            "ToolTip": QT_TRANSLATE_NOOP(
                "Sun Ray", "Declare your FreeCAD objects to be optical mirrors"
            ),
        }
